...
def chat(method="entire_recipe"):
    ...
    pantry = "Here are the ingredients I have available in my pantry: chicken, mushrooms, butter, salt, pepper, garlic, onion, olive oil, flour, sugar, soy sauce, tomato paste, oregano, thyme, basil, parsley, paprika, cumin, cinnamon, baking powder, baking soda, eggs, milk, pasta, rice, canned tomatoes, chicken broth, vinegar, honey, mustard, chili powder, cornstarch, brown sugar, bread crumbs, parmesan cheese, bay leaves, lemon, carrots, potatoes, bell peppers, spinach, zucchini, celery, broccoli, cauliflower, peas, green beans, kale."
    query = "I want to use chicken, celery, and carrots to cook a recipe."
